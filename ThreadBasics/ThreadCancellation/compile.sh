...
gcc -g -c master_slave1_deferred_cancellation.c -o master_slave1_deferred_cancellation.o
gcc -g master_slave1_deferred_cancellation.o -o master_slave1_deferred_cancellation.exe -lpthread
